...
class OpenAPISpec(StatusModel):
    ...
    components: Dict[str, Any] = Field(default_factory=dict, description="API components")
    security: List[Dict[str, Any]] = Field(default_factory=list, description="Security schemes")
...
class Requirements(StatusModel):
    ...
    requirements_type: str = Field(default="functional", description="Type of requirements")
    
    # Requirements content
    functional_requirements: List[Dict[str, Any]] = Field(default_factory=list, description="Functional requirements")
    non_functional_requirements: List[Dict[str, Any]] = Field(default_factory=list, description="Non-functional requirements")
    user_stories: List[Dict[str, Any]] = Field(default_factory=list, description="User stories")
    acceptance_criteria: List[Dict[str, Any]] = Field(default_factory=list, description="Acceptance criteria")
    
    # Stakeholder information
    stakeholders: List[Dict[str, Any]] = Field(default_factory=list, description="Stakeholder information")
    ...
    priority_levels: Dict[str, str] = Field(default_factory=dict, description="Priority levels")
    categories: List[str] = Field(default_factory=list, description="Requirement categories")
    ...
    project_id: UUID = Field(..., description="Associated project ID")
    context_id: Optional[UUID] = Field(None, description="Associated context ID")
    derived_specs: List[str] = Field(default_factory=list, description="Derived specification IDs")
...
class Architecture(StatusModel):
    ...
    layers: List[Dict[str, Any]] = Field(default_factory=list, description="Architecture layers")
    patterns: List[Dict[str, Any]] = Field(default_factory=list, description="Design patterns")
    technologies: List[Dict[str, Any]] = Field(default_factory=list, description="Technology stack")
    
    # System design
    system_overview: Dict[str, Any] = Field(default_factory=dict, description="System overview")
    data_flow: List[Dict[str, Any]] = Field(default_factory=list, description="Data flow diagrams")
    interfaces: List[Dict[str, Any]] = Field(default_factory=list, description="System interfaces")
    security_model: Dict[str, Any] = Field(default_factory=dict, description="Security model")
    
    # Quality attributes
    quality_attributes: Dict[str, Any] = Field(default_factory=dict, description="Quality attributes")
    performance_requirements: Dict[str, Any] = Field(default_factory=dict, description="Performance requirements")
    scalability_requirements: Dict[str, Any] = Field(default_factory=dict, description="Scalability requirements")
    ...
    derived_implementations: List[str] = Field(default_factory=list, description="Derived implementation IDs")
...
class Implementation(StatusModel):
    ...
    implementation_type: str = Field(default="code", description="Type of implementation")
    
    # Implementation structure
    modules: List[Dict[str, Any]] = Field(default_factory=list, description="Code modules")
    files: List[Dict[str, Any]] = Field(default_factory=list, description="Implementation files")
    dependencies: List[Dict[str, Any]] = Field(default_factory=list, description="Dependencies")
    tests: List[Dict[str, Any]] = Field(default_factory=list, description="Test specifications")
    ...
    environment_config: Dict[str, Any] = Field(default_factory=dict, description="Environment configuration")
    ...
    project_id: UUID = Field(..., description="Associated project ID")
    context_id: Optional[UUID] = Field(None, description="Associated context ID")
    architecture_id: Optional[str] = Field(None, description="Associated architecture ID")
