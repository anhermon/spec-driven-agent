...
class TaskDependency(StatusModel):
    ...
    prerequisite_task_id: UUID = Field(..., description="Task that must be completed first")
    ...
    # Status
    satisfied: bool = Field(default=False, description="Whether dependency is satisfied")
    satisfied_at: Optional[datetime] = Field(None, description="When dependency was satisfied")
...
class Task(StatusModel):
    ...
    dependent_tasks: List[UUID] = Field(default_factory=list, description="Tasks that depend on this one")
    ...
    effort_estimate: Optional[float] = Field(None, description="Effort estimate in hours")
    ...
    milestones: List[Dict[str, Any]] = Field(default_factory=list, description="Task milestones")
    ...
    notifications: List[str] = Field(default_factory=list, description="Notification IDs")
    ...
    status_history: List[Dict[str, Any]] = Field(default_factory=list, description="Status history")
