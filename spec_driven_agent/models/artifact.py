...
class ArtifactMetadata(StatusModel):
    ...
    maintainability_score: Optional[float] = Field(None, description="Maintainability score")
    ...
    access_history: List[Dict[str, Any]] = Field(default_factory=list, description="Access history")
    
    # Relationships
    dependencies: List[str] = Field(default_factory=list, description="Dependency artifact IDs")
    derived_from: List[str] = Field(default_factory=list, description="Source artifact IDs")
    derived_to: List[str] = Field(default_factory=list, description="Derived artifact IDs")
...
class Artifact(StatusModel):
    ...
    generated_from: Optional[str] = Field(None, description="Source specification or requirement")
    ...
    supersedes: List[str] = Field(default_factory=list, description="Superseded artifact IDs")
    ...
    delete_access: List[UUID] = Field(default_factory=list, description="Delete access user/agent IDs")
    
    # Metadata
    tags: List[str] = Field(default_factory=list, description="Artifact tags")
    categories: List[str] = Field(default_factory=list, description="Artifact categories")
    ...
    # Configuration
    config: Dict[str, Any] = Field(default_factory=dict, description="Artifact configuration")
    settings: Dict[str, Any] = Field(default_factory=dict, description="Artifact settings")
